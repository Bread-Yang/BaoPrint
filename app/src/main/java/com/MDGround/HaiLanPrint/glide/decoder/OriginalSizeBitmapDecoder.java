package com.MDGround.HaiLanPrint.glide.decoder;

import android.content.Context;
import android.graphics.Bitmap;
import android.graphics.BitmapFactory;

import com.MDGround.HaiLanPrint.glide.resource.OriginalSizeBitmapResource;
 ...
 */
public class OriginalSizeBitmapDecoder implements ResourceDecoder<File, OriginalSizeBitmap> {

    private final Context mContext;

    public OriginalSizeBitmapDecoder(Context context) {
        mContext = context;
    }
